...
const STORE = [
  ...
  },
  {
    ...
    image: '<img class="questionImage" src="images/CartoonLink.png" alt="Link">',
    answers: [
      '3',
      '4',
      '5',
  ...
  },
  {
    ...
    image: '<img class="questionImage" src="images/ZeldaBreathoftheWild.jpg" alt="Zelda">',
    answers: [
  ...
  },
  {
    ...
    image: '<img class="questionImage" src="images/Hyrulianshield.png" alt="Hyrule">',
    answers: [
      'The Legend of Zelda',
...
function showQuestion(){
 ...
 if (currentQuestion < STORE.length){
  $('.quiz').html('');$('.quiz').append(`<h2>${question.title}</h2>`);
...
function wrongAnswer(){
  $('.response').html(
    `<h2>Wrong answer! The correct answer was <br> ${STORE[currentQuestion].correct}</h2><img src="images/FML.png" alt="correct answer" class="images" width="200px"><p>Ganon is getting stronger!</p><button type="button" class="nextButton button">Next</button>`);
    $('.response').show();
}
...
function showSummary(){
  $('.response').hide();
  $('.summary').show();
  $('.summary p').text("Congrats! You scored "+score+" out of "+STORE.length+" correct!");
}
